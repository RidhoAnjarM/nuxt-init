<template>
    <section>
        <ul class="flex justify-between mt-[70px] mb-[70px] items-center">
            ...
            <li><a href="#"><img src="~/assets/image/notion.svg" alt="notion"></a></li>
            <li><a href="#"><img src="~/assets/image/netflix.svg" alt="netflix"></a></li>
            <li><a href="#"><img src="~/assets/image/zoom.svg" alt="zoom"></a></li>
        </ul>
    </section>
</template>